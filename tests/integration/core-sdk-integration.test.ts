...
class MockIssueFlowApp {
  public pluginRegistry: MockPluginRegistry;
  private config: any;
...
class MockPluginRegistry {
  ...
  async registerPlugin(plugin: any, config?: any) {
...
class MockIssueFlowClient {
  private config: any;
  private mockApp: MockIssueFlowApp;
...
class MockIntegrationPlugin {
  readonly name = 'integration-test-plugin';
  ...
  async onIssueCreated(event: any) {
...
export { runCoreSDKIntegrationTests };

export default runCoreSDKIntegrationTests;
